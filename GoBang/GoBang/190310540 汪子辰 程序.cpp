...
{//以下是各种可能连成一线的情况
	if(achBoard[0][0]==chSort && achBoard[1][1]==chSort && achBoard[2][2]==chSort)
		return 1;
	else if(achBoard[0][1]==chSort && achBoard[0][2]==chSort && achBoard[0][3]==chSort)
		return 1;	
	else if(achBoard[1][1]==chSort && achBoard[1][2]==chSort && achBoard[1][3]==chSort)
		return 1;
	else if(achBoard[2][1]==chSort && achBoard[2][2]==chSort && achBoard[2][3]==chSort)
		return 1;
	else if(achBoard[3][1]==chSort && achBoard[3][2]==chSort && achBoard[3][3]==chSort)
		return 1;
	else if(achBoard[3][0]==chSort && achBoard[3][1]==chSort && achBoard[3][2]==chSort)
		return 1;
	else if(achBoard[1][0]==chSort && achBoard[2][0]==chSort && achBoard[3][0]==chSort)
		return 1;	
	else if(achBoard[1][1]==chSort && achBoard[2][1]==chSort && achBoard[3][1]==chSort)
		return 1;	
	else if(achBoard[1][2]==chSort && achBoard[2][2]==chSort && achBoard[3][2]==chSort)
		return 1;	
	else if(achBoard[1][3]==chSort && achBoard[2][3]==chSort && achBoard[3][3]==chSort)
		return 1;	
	else if(achBoard[0][3]==chSort && achBoard[1][3]==chSort && achBoard[3][3]==chSort)
		return 1;	
	else if(achBoard[1][1]==chSort && achBoard[2][2]==chSort && achBoard[3][3]==chSort)
		return 1;	
	else if(achBoard[0][1]==chSort && achBoard[1][2]==chSort && achBoard[2][3]==chSort)
		return 1;	
	else if(achBoard[1][0]==chSort && achBoard[2][1]==chSort && achBoard[3][2]==chSort)
		return 1;	
	else if(achBoard[3][0]==chSort && achBoard[2][1]==chSort && achBoard[1][2]==chSort)
		return 1;	
	else if(achBoard[3][1]==chSort && achBoard[2][2]==chSort && achBoard[1][3]==chSort)
		return 1;	
	else if(achBoard[2][1]==chSort && achBoard[1][2]==chSort && achBoard[0][3]==chSort)
		return 1;		
